...
public class ImageAdapter extends BaseAdapter {
    ...
    public void select(Image image) {
        if (selectedImageList.contains(image)) {
            ...
            if (BimpHandler.haveCompress.contains(image.path)) {
                BimpHandler.mPhotoNum.remove(BimpHandler.haveCompress.indexOf(image.path));
                BimpHandler.haveCompress.remove(image.path);
            }
        } else {
            selectedImageList.add(image);
        }
